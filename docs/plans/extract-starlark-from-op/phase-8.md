...
- **Steps 16, 17, 18, 19** complete; closed inline as part of the 13.0(n) and follow-on commits. **Steps
  20, 21, 22** + new step 23 + open design items O1–O3 remain. Step 23 is the explicit phase-8 PR gate
  — phase-8 is not PR-eligible to develop until step 23 closes AND the full `make test` suite is green.
