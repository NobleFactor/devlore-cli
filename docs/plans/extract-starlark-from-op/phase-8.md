...
k.15, moved out of 13.0 — tracked as #282 under step 16's preflight scope. **13.0(n)** (writ
graph executor) is now the only remaining 13.0 sub-item. k.14 closed by audit: every
