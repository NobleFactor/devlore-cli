...
from the verified command surface: the execution store, `writ status` (all eight
...
1. `writ status --help` claimed stale-vs-modified attribution was "indistinguishable until
