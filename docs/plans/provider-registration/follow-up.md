...
[x] 4. Remove all generated files from source control. `make clean` should remove them. `git` should ignore them. There is nothing to preserve. star is now definitive.
