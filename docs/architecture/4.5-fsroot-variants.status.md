...
justified by bootstrapping rather than access, so the design collapses to a single sandbox behaviour and
two types. No implementation.

## Settled

- [x] **One sandbox behaviour, and it is the kernel's.** fsroot does not offer a choice of sandbox.
