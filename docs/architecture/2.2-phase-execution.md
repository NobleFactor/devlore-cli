...
Run status is a triplet — two orthogonal dimensions plus a reason (settled 2026-07-05, refined 2026-07-06 /
2026-07-07; realization: phase-8 step 41; the Go type is `RunStatus{Phase, Condition, Reason}`). **Phase** — where
...
as it stood. **Reason** — the prose driver of the latest move, carried on the status for informative logs.
