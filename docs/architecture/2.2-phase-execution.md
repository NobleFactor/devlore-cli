...
- **Presumed abort** — a receipt exists only for a *completed* action; a still-running unit is canceled, not
  compensated.
...
- [5 Graph and Trace Integrity](5-graph-trace-integrity.md) / [5.2 Recovery Serialization](5.2-recovery-serialization.md) /
