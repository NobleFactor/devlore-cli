...
Salvaged from noblefactor-ops' copy of this document 2026-09-24 (#937). It had no counterpart here,
and `10-command-line-interface.md` §3 states only the two-token `<binary> <noun> <verb>` rule for
writ and lore.
