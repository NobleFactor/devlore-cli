...
var (
	// providerType is the type of the shellcheck provider.
	providerType = reflect.TypeOf((*provider.Provider)(nil)).Elem()

	// Receiver is the ReceiverFactory for instances of the shellcheck provider.
...
// factory implements op.ReceiverFactory for the shellcheck provider.
...
//
// Returns:
//   - string: the receiver name "shellcheck".
func (f *receiverFactory) ReceiverName() string { return "shellcheck" }
