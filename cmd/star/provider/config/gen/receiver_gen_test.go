...
import (
	...
	configgen "github.com/NobleFactor/devlore-cli/cmd/star/provider/config/gen"
...
func TestAttrNames(t *testing.T) {
	...
	r := bind.WrapProviderInExecutingReceiver(configgen.Receiver, &provider.Provider{})
	names := r.AttrNames()
	if len(names) == 0 {
