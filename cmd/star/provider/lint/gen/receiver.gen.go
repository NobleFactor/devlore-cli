...
var (
	// providerType is the type of the lint provider.
	providerType = reflect.TypeOf((*provider.Provider)(nil)).Elem()

	// Receiver is the ReceiverFactory for instances of the lint provider.
...
//
// Returns:
//   - string: the receiver name "lint".
func (f *receiverFactory) ReceiverName() string { return "lint" }
