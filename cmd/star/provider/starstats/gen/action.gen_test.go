...
func TestComputeStatsAction_DryRun(t *testing.T) {

	action := getAction(t, provider.ComputeStats)
	ctx, buf := dryRunCtx(t)
	...
	wantSubstring := "[dry-run] " + string(provider.ComputeStats)
