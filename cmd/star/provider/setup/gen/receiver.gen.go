...
var (
	// providerType is the type of the setup provider.
	providerType = reflect.TypeOf((*provider.Provider)(nil)).Elem()

	// Receiver is the ReceiverFactory for instances of the setup provider.
...
// factory implements op.ReceiverFactory for the setup provider.
...
//
// Returns:
//   - string: the receiver name "setup".
func (f *receiverFactory) ReceiverName() string { return "setup" }
