...
// Receiver is the ReceiverFactory for the starindex provider.
var Receiver op.ReceiverFactory = &receiverFactory{}

// factory implements op.ReceiverFactory for the starindex provider.
...
//
// Returns:
//   - string: the receiver name "starindex".
func (f *receiverFactory) ReceiverName() string { return "starindex" }
