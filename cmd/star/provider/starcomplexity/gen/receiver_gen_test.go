...
func TestAttrNames(t *testing.T) {
	...
	r := bind.WrapProviderInExecutingReceiver(starcomplexitygen.Receiver, &provider.Provider{})
	names := r.AttrNames()
	if len(names) == 0 {
