...
// Real shell-out implementations for the Darwin managers (brew, port, launchd). The implicit
// _darwin.go build constraint scopes this file to Darwin hosts; non-Darwin hosts get the stub
// implementations from darwin_managers_other.go.

// =============================================================================
// Homebrew Package Manager — shell-out methods
// =============================================================================
...
func (m *brewManager) AddRepo(_, _, name string) PlatformResult {
	return runShellCommand("brew tap "+name, false)
}

// =============================================================================
// MacPorts Package Manager — shell-out methods
// =============================================================================
