...
// error [Result] instead — the type is usable at plan time but every run-time invocation fails loudly with
...
func (m *brewManager) installRaw(_ []string, _ map[string]any) Result {
	return Result{OK: false, Stderr: "brew " + darwinStubMessage}
}
...
// Returns:
//   - `Result`: an error result naming the missing tool.
func (m *brewManager) removeRaw(_ []string) Result {
	return Result{OK: false, Stderr: "brew " + darwinStubMessage}
}
...
// Returns:
//   - `Result`: an error result naming the missing tool.
func (m *launchdManager) Disable(_ string) Result {
	return Result{OK: false, Stderr: "launchctl " + darwinStubMessage}
}
...
// Returns:
//   - `Result`: an error result naming the missing tool.
func (m *launchdManager) Enable(_ string) Result {
	return Result{OK: false, Stderr: "launchctl " + darwinStubMessage}
}
...
// Returns:
//   - `Result`: an error result naming the missing tool.
func (m *launchdManager) Start(_ string) Result {
	return Result{OK: false, Stderr: "launchctl " + darwinStubMessage}
}
...
// Returns:
//   - `Result`: an error result naming the missing tool.
func (m *launchdManager) Stop(_ string) Result {
	return Result{OK: false, Stderr: "launchctl " + darwinStubMessage}
}
...
// Returns:
//   - `Result`: an error result naming the missing tool.
func (m *portManager) installRaw(_ []string, _ map[string]any) Result {
	return Result{OK: false, Stderr: "port " + darwinStubMessage}
}
...
// Returns:
//   - `Result`: an error result naming the missing tool.
func (m *portManager) removeRaw(_ []string) Result {
	return Result{OK: false, Stderr: "port " + darwinStubMessage}
}
