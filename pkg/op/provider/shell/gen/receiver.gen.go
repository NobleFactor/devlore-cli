...
// Receiver is the ReceiverFactory for the shell provider.
var Receiver op.ReceiverFactory = &receiverFactory{}

// factory implements op.ReceiverFactory for the shell provider.
...
//
// Returns:
//   - string: the receiver name "shell".
func (f *receiverFactory) ReceiverName() string { return "shell" }
