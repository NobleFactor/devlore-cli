...
// Receiver is the ReceiverFactory for the starcode provider.
var Receiver op.ReceiverFactory = &receiverFactory{}

// factory implements op.ReceiverFactory for the starcode provider.
...
//
// Returns:
//   - string: the receiver name "starcode".
func (f *receiverFactory) ReceiverName() string { return "starcode" }
