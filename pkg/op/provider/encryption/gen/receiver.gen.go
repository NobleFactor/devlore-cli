...
// Receiver is the ReceiverFactory for the encryption provider.
var Receiver op.ReceiverFactory = &receiverFactory{}

// factory implements op.ReceiverFactory for the encryption provider.
...
//
// Returns:
//   - string: the receiver name "encryption".
func (f *receiverFactory) ReceiverName() string { return "encryption" }
