...
// Receiver is the ReceiverFactory for the regexp provider.
var Receiver op.ReceiverFactory = &receiverFactory{}

// factory implements op.ReceiverFactory for the regexp provider.
...
//
// Returns:
//   - string: the receiver name "regexp".
func (f *receiverFactory) ReceiverName() string { return "regexp" }
