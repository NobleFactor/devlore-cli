...
// Receiver is the ReceiverFactory for the git provider.
var Receiver op.ReceiverFactory = &receiverFactory{}

// factory implements op.ReceiverFactory for the git provider.
...
//
// Returns:
//   - string: the receiver name "git".
func (f *receiverFactory) ReceiverName() string { return "git" }
