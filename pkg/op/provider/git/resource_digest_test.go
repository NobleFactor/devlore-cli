...
// initRepo creates a fresh git repository at dir on a test branch. Using "test/k4" rather than "main"
// dodges any host-side hooks (project, user, or global) that block direct commits to protected branches.
