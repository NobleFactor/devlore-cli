...
// TestAnyEntry_Exists_RefusesAKindTheTaxonomyLacks pins the bounded half of the permissive predicate: an
...
func TestAnyEntry_Exists_RefusesAKindTheTaxonomyLacks(t *testing.T) {
	...
	if anyEntryAt(t, environment, "a-fifo").Exists() {
