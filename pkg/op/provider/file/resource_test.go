...
func TestResource_Addressing_IsLocation(t *testing.T) {
	...
	r, err := DiscoverResource(p.RuntimeEnvironment(), filepath.Join(tmp, "anything.txt"))
	if err != nil {
...
func TestResource_Digest_MatchesContent(t *testing.T) {
	...
	r, err := DiscoverResource(p.RuntimeEnvironment(), path)
	if err != nil {
		t.Fatalf("NewResource: %v", err)
	}
...
func TestResource_Digest_DiffersAcrossContent(t *testing.T) {
	...
	rA, err := DiscoverResource(p.RuntimeEnvironment(), pathA)
	if err != nil {
		t.Fatalf("NewResource(A): %v", err)
	}
	rB, err := DiscoverResource(p.RuntimeEnvironment(), pathB)
	if err != nil {
...
func TestResource_Digest_DirectoryReturnsErrUnimplemented(t *testing.T) {
	...
	r, err := DiscoverResource(p.RuntimeEnvironment(), dirPath)
	if err != nil {
		t.Fatalf("NewResource: %v", err)
	}
...
func TestResource_Digest_FileMissing(t *testing.T) {
	...
	r, err := DiscoverResource(p.RuntimeEnvironment(), filepath.Join(tmp, "missing.txt"))
	if err != nil {
		t.Fatalf("NewResource: %v", err)
	}
