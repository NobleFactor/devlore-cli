...
// Receiver is the ReceiverFactory for the service provider.
var Receiver op.ReceiverFactory = &receiverFactory{}

// factory implements op.ReceiverFactory for the service provider.
...
//
// Returns:
//   - string: the receiver name "service".
func (f *receiverFactory) ReceiverName() string { return "service" }
