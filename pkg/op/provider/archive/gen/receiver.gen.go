...
// Receiver is the ReceiverFactory for the archive provider.
var Receiver op.ReceiverFactory = &receiverFactory{}

// factory implements op.ReceiverFactory for the archive provider.
...
//
// Returns:
//   - string: the receiver name "archive".
func (f *receiverFactory) ReceiverName() string { return "archive" }
