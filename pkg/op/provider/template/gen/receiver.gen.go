...
// Receiver is the ReceiverFactory for the template provider.
var Receiver op.ReceiverFactory = &receiverFactory{}

// factory implements op.ReceiverFactory for the template provider.
...
//
// Returns:
//   - string: the receiver name "template".
func (f *receiverFactory) ReceiverName() string { return "template" }
