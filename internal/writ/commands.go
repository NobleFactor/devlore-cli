...
func adoptFile(filePath, targetRoot, projectDir string, verbose, dryRun bool) (int, error) {
	...
	if _, err := fp.Mkdir(file.Resource{SourcePath: file.SourcePath{Abs: destDir}}, 0o755); err != nil {
	...
	// Move file to repo
	if _, _, err := fp.Move(file.Resource{SourcePath: file.SourcePath{Abs: filePath}}, file.Resource{SourcePath: file.SourcePath{Abs: destPath}}); err != nil {
	...
	// Create symlink back
	if _, _, err := fp.Link(file.Resource{SourcePath: file.SourcePath{Abs: destPath}}, file.Resource{SourcePath: file.SourcePath{Abs: filePath}}); err != nil {
