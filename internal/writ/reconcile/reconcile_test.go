...
func TestCheckEntry_LinkedCorrectly(t *testing.T) {
	...
	// Check entry
	entry := checkEntry(sourceFile, targetFile, "test.txt", "testproject", "file.link")
...
func TestCheckEntry_Orphan(t *testing.T) {
	...
	entry := checkEntry(nonexistent, targetFile, "test.txt", "testproject", "file.link")
...
func TestCheckEntry_CopiedFile(t *testing.T) {
	...
	entry := checkEntry(sourceFile, targetFile, "config", "testproject", "file.copy")
